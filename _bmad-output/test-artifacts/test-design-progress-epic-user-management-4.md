...
epicSourceHeading: '### Epic 4: Organizational Relationships'
...
planPath: '_bmad-output/test-artifacts/test-design-epic-user-management-4.md'
---

# Test Design Progress — Epic UM-E4, Organizational Relationships
...
>   report exists for this epic. `test-design-validation-report-epic-user-management-4.md` is
...
| `runScope` | `epic` |
| `runKey` | `epic-user-management-4` |
| Canonical `epicId` | `UM-E4` |
| Epic title | Organizational Relationships |
| Domain | `user-management` |
| Number | `4` |
| **Source epic ID and path** | `UM-E4` in `_bmad-output/planning-artifacts/user-management/epics.md`, heading `### Epic 4: Organizational Relationships` |
| Plan produced | `_bmad-output/test-artifacts/test-design-epic-user-management-4.md` |
...
| --- | --- | --- | --- |
| `_bmad-output/test-artifacts/test-design-epic-user-management-4.md` | `5135b7f988999ceb3ac9f9bc2653e4314ec27613076fce8be5576a8eb7b0b782` | ungranted | NOT RUN |

> **Hash re-recorded 2026-09-11.** This column previously read *"SHA-256 at the moment this
> checkpoint was written"* and held `32fb1b841351d3b7295e631afad5ab3de45fcc8836c445d373040833306ac7ac`, which was correct for the plan as it
...
`test-design-validation-report-epic-user-management-4.md` and **never** overwrites the system
