...
epicSourceHeading: '### Epic 3: Career Timeline'
...
planPath: '_bmad-output/test-artifacts/test-design-epic-user-management-3.md'
---

# Test Design Progress — Epic UM-E3, Career Timeline
...
>   report exists for this epic. `test-design-validation-report-epic-user-management-3.md` is
...
| `runScope` | `epic` |
| `runKey` | `epic-user-management-3` |
| Canonical `epicId` | `UM-E3` |
| Epic title | Career Timeline |
| Domain | `user-management` |
| Number | `3` |
| **Source epic ID and path** | `UM-E3` in `_bmad-output/planning-artifacts/user-management/epics.md`, heading `### Epic 3: Career Timeline` |
| Plan produced | `_bmad-output/test-artifacts/test-design-epic-user-management-3.md` |
...
| --- | --- | --- | --- |
| `_bmad-output/test-artifacts/test-design-epic-user-management-3.md` | `9ea0a8f38c3ebb03bff5316d4fc7fde9c17be8580b0e177a63df76147345878e` | ungranted | NOT RUN |
...
`test-design-validation-report-epic-user-management-3.md` and **never** overwrites the system
