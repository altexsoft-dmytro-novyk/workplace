...
epicSourceHeading: '### Epic 0: Access Control Adoption'
...
planPath: '_bmad-output/test-artifacts/test-design-epic-user-management-0.md'
---

# Test Design Progress — Epic UM-E0, Access Control Adoption
...
>   report exists for this epic. `test-design-validation-report-epic-user-management-0.md` is
...
| `runScope` | `epic` |
| `runKey` | `epic-user-management-0` |
| Canonical `epicId` | `UM-E0` |
| Epic title | Access Control Adoption |
| Domain | `user-management` |
| Number | `0` |
| **Source epic ID and path** | `UM-E0` in `_bmad-output/planning-artifacts/user-management/epics.md`, heading `### Epic 0: Access Control Adoption` |
| Plan produced | `_bmad-output/test-artifacts/test-design-epic-user-management-0.md` |
| Stories in scope | The plan states none: no migrated obligation routes to a specific story of this epic. **That is not a statement that its stories need no test design.** |
...
| --- | --- | --- | --- |
| `_bmad-output/test-artifacts/test-design-epic-user-management-0.md` | `b0aba3eabc9681bf24e5ac86eca9dec9637e3172bb7c14340be21e45d29c2e61` | ungranted | NOT RUN |
...
`test-design-validation-report-epic-user-management-0.md` and **never** overwrites the system
