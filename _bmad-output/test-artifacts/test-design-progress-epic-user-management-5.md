...
epicSourceHeading: '### Epic 5: Employment Lifecycle'
...
planPath: '_bmad-output/test-artifacts/test-design-epic-user-management-5.md'
---

# Test Design Progress — Epic UM-E5, Employment Lifecycle
...
>   report exists for this epic. `test-design-validation-report-epic-user-management-5.md` is
...
| `runScope` | `epic` |
| `runKey` | `epic-user-management-5` |
| Canonical `epicId` | `UM-E5` |
| Epic title | Employment Lifecycle |
| Domain | `user-management` |
| Number | `5` |
| **Source epic ID and path** | `UM-E5` in `_bmad-output/planning-artifacts/user-management/epics.md`, heading `### Epic 5: Employment Lifecycle` |
| Plan produced | `_bmad-output/test-artifacts/test-design-epic-user-management-5.md` |
...
`test-design-validation-report-epic-user-management-5.md` and **never** overwrites the system
