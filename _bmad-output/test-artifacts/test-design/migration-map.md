...
| **U-2** *(resolved 2026-09-11)* | **Resolved** — explicit recorded Product Owner + Architect sign-off per package; PM/AD-19/AD-20 are direction only | Product Owner + Architect | §5.2 | Both sign-offs remain **ungranted** until recorded. See `test-design-architecture.md` § Sign-off-ready packages. |
