...
schedule. **Four exist:** `epic-platform-1` (PASS, 2026-09-12), `epic-platform-2` (CONCERNS,
2026-09-11), `epic-platform-3` (PASS, 2026-09-12, fresh independent validation), and
`epic-platform-4` (PASS, 2026-09-12, fourth re-validation, after the AF-3 decision; one non-blocking documentation-accuracy finding G-1); see their rows above.
