...
epicSourceHeading: '### Epic 7: Visibility-Safe Filtering and Columns'
...
planPath: '_bmad-output/test-artifacts/test-design-epic-user-management-7.md'
---

# Test Design Progress — Epic UM-E7, Visibility-Safe Filtering and Columns
...
>   report exists for this epic. `test-design-validation-report-epic-user-management-7.md` is
...
| `runScope` | `epic` |
| `runKey` | `epic-user-management-7` |
| Canonical `epicId` | `UM-E7` |
| Epic title | Visibility-Safe Filtering and Columns |
| Domain | `user-management` |
| Number | `7` |
| **Source epic ID and path** | `UM-E7` in `_bmad-output/planning-artifacts/user-management/epics.md`, heading `### Epic 7: Visibility-Safe Filtering and Columns` |
| Plan produced | `_bmad-output/test-artifacts/test-design-epic-user-management-7.md` |
...
| --- | --- | --- | --- |
| `_bmad-output/test-artifacts/test-design-epic-user-management-7.md` | `fbe7c83285a36b0b15a1e10dbf9c7ed22bdfd55ff21a04208c3b54052c058a91` | ungranted | NOT RUN |
...
`test-design-validation-report-epic-user-management-7.md` and **never** overwrites the system
