...
epicSourceHeading: '### Epic 1: Permission-Safe People Directory'
...
planPath: '_bmad-output/test-artifacts/test-design-epic-platform-capabilities-1.md'
---

# Test Design Progress — Epic PMC-E1, Permission-Safe People Directory
...
>   report exists for this epic. `test-design-validation-report-epic-platform-capabilities-1.md` is
...
| `runScope` | `epic` |
| `runKey` | `epic-platform-capabilities-1` |
| Canonical `epicId` | `PMC-E1` |
| Epic title | Permission-Safe People Directory |
| Domain | `platform-capabilities` |
| Number | `1` |
| **Source epic ID and path** | `PMC-E1` in `_bmad-output/planning-artifacts/platform-capabilities/epics.md`, heading `### Epic 1: Permission-Safe People Directory` |
| Plan produced | `_bmad-output/test-artifacts/test-design-epic-platform-capabilities-1.md` |
...
| Input | SHA-256 |
| --- | --- |
| `_bmad-output/planning-artifacts/platform-capabilities/epics.md` (canonical epic source) | `722afe8cc1bc1db3f1d2ae770c379242a7ec95611a214af2929789b4454880d2` |
...
| --- | --- | --- | --- |
| `_bmad-output/test-artifacts/test-design-epic-platform-capabilities-1.md` | `733e50d40960bc31869f9752d2452b27d063cebffaf9b9791d8c86cba6f9cf40` | ungranted | NOT RUN |
...
`test-design-validation-report-epic-platform-capabilities-1.md` and **never** overwrites the system
