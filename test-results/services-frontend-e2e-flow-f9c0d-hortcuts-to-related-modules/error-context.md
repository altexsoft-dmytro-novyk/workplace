...
- Name: services/frontend/e2e/flows/dashboards/dashboards.spec.ts >> People Management Dashboards — Unit Manager (Story 2.1 / PMC-E2-S2.1) >> FE-DASH-01 · Populated state with live scope, headcount, and people table >> displays navigation shortcuts to related modules
- Location: services/frontend/e2e/flows/dashboards/dashboards.spec.ts:99:5
