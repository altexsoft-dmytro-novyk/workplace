...
- Name: services/frontend/e2e/flows/dashboards/dashboards.spec.ts >> People Management Dashboards — Unit Manager (Story 2.1 / PMC-E2-S2.1) >> FE-DASH-01 · Populated state with live scope, headcount, and people table >> renders active headcount in data-stat mono with .wscope footer
- Location: services/frontend/e2e/flows/dashboards/dashboards.spec.ts:56:5
