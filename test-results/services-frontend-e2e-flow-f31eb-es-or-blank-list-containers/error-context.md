...
- Name: services/frontend/e2e/flows/dashboards/dashboards.spec.ts >> People Management Dashboards — Unsourced Widget Slots (Story 2.2 / PMC-E2-S2.2) >> FE-DASH-10 · Prevention of fake zero, dashes, blank space, empty charts, or fabricated data in unavailable slots >> unavailable action items slots do not render numeric 0, dashes, or blank list containers
- Location: services/frontend/e2e/flows/dashboards/dashboards.spec.ts:558:5
