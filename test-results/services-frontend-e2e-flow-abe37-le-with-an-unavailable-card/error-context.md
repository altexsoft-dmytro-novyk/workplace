...
- Name: services/frontend/e2e/flows/dashboards/dashboards.spec.ts >> People Management Dashboards — Unsourced Widget Slots (Story 2.2 / PMC-E2-S2.2) >> FE-DASH-12 · State disambiguation across unavailable source, legitimate measured zero, empty scope, loading skeleton, and access denial >> empty reporting scope (FE-DASH-03) renders .emptyst empty-state component and does not replace the table with an unavailable card
- Location: services/frontend/e2e/flows/dashboards/dashboards.spec.ts:751:5
