...
- Name: services/frontend/e2e/flows/dashboards/dashboards.spec.ts >> People Management Dashboards — Unit Manager (Story 2.1 / PMC-E2-S2.1) >> FE-DASH-03 · Legitimate zero headcount and empty scope >> empty reporting scope renders the empty-state component instead of an error or table rows
- Location: services/frontend/e2e/flows/dashboards/dashboards.spec.ts:150:5
