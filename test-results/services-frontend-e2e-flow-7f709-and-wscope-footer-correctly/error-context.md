...
- Name: services/frontend/e2e/flows/dashboards/dashboards.spec.ts >> People Management Dashboards — Unit Manager (Story 2.1 / PMC-E2-S2.1) >> FE-DASH-04 · Scope correctness and reporting-line isolation >> renders the evaluated scope policy label and .wscope footer correctly
- Location: services/frontend/e2e/flows/dashboards/dashboards.spec.ts:192:5
