...
- Name: services/frontend/e2e/flows/dashboards/dashboards.spec.ts >> People Management Dashboards — Unit Manager (Story 2.1 / PMC-E2-S2.1) >> FE-DASH-06 · Tier-safe people table and uncovered columns >> does not render silently blank cells or fabricated values for missing source capabilities
- Location: services/frontend/e2e/flows/dashboards/dashboards.spec.ts:302:5
