...
- Name: services/frontend/e2e/flows/dashboards/dashboards.spec.ts >> People Management Dashboards — Unsourced Widget Slots (Story 2.2 / PMC-E2-S2.2) >> FE-DASH-13 · Semantic structure, accessibility, responsive layout, and lack of customization for unavailable widget cards >> unavailable widget cards do not introduce interactive focus traps or unexpected tabbable descendants
- Location: services/frontend/e2e/flows/dashboards/dashboards.spec.ts:803:5
