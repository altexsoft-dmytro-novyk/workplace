...
- Name: services/frontend/e2e/flows/dashboards/dashboards.spec.ts >> People Management Dashboards — Unsourced Widget Slots (Story 2.2 / PMC-E2-S2.2) >> FE-DASH-11 · Multi-widget coexistence and independent slot metadata isolation >> displays metadata supplied by each corresponding property without cross-slot substitution (allowing identical metadata where legitimately shared, such as PM-FR-19 action items)
- Location: services/frontend/e2e/flows/dashboards/dashboards.spec.ts:648:5
