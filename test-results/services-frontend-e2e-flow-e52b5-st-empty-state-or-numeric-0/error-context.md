...
- Name: services/frontend/e2e/flows/dashboards/dashboards.spec.ts >> People Management Dashboards — Unsourced Widget Slots (Story 2.2 / PMC-E2-S2.2) >> FE-DASH-12 · State disambiguation across unavailable source, legitimate measured zero, empty scope, loading skeleton, and access denial >> unavailable widget slots render unavailable cards and never display .emptyst empty state or numeric 0
- Location: services/frontend/e2e/flows/dashboards/dashboards.spec.ts:722:5
