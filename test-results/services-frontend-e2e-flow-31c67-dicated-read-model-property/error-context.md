...
- Name: services/frontend/e2e/flows/dashboards/dashboards.spec.ts >> People Management Dashboards — Unsourced Widget Slots (Story 2.2 / PMC-E2-S2.2) >> FE-DASH-11 · Multi-widget coexistence and independent slot metadata isolation >> each unavailable widget slot renders from its own dedicated read-model property
- Location: services/frontend/e2e/flows/dashboards/dashboards.spec.ts:628:5
