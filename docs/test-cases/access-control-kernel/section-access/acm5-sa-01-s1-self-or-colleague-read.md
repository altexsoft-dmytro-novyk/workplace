# ACM5-SA-01 · S1 grants read to Self or Colleague alone

**Trace:**

- SPEC [CAP-5](../../../../_bmad-output/specs/spec-access-control-kernel-mvp/SPEC.md#capabilities) — S1 is `read` for Self or Colleague where no stronger Phase-0 audience applies.
...
- [access-control.md § The AccessControl facade](../../../architecture/access-control.md#the-accesscontrol-facade-ad-9) and [§ Matrix exceptions](../../../architecture/access-control.md#matrix-exceptions-33) — `canAccessSection` returns the base decision and S1 has the documented matrix/derived-field limits.
...
resolved audience set into the S1 base decision; it does not inspect policy
