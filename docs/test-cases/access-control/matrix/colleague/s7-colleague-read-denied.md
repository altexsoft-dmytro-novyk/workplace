# AC-M-S7-CO-R-DEN · colleague read s7 denied

**Trace:** §3.2 S7 · AD-10

## Scenario

**Given** Colin is an authenticated employee with **no** applicable audience for Alice's Management notes section (§3.2 cell is `—` for colleague).

**When** Colin requests Alice's Management notes data.
