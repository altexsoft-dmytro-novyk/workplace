...
**Given** Alice's timeline holds system events (joining, grade change) and a manual backfill entry.

**When** she requests her career timeline (S9).

**Then** she sees all events, typed and dated, system-generated and manual alike.
